...
if __name__ == '__main__':
    gapf = read_gap_file('data/gap_hg19.bed', 1e6)
    cnt_file = '/data/lmna_ea/b__counts10kb/ad04_lmna_rep1.counts'
    scores_per_chrom = util.read_scores(cnt_file, set(['chr1']),
                                        scorefunc='log2-ratio')
